...
const   Calculator  =   {
    ...
    First_Operand: null,
    //this checks wether the second operand has been input by the user
...
function    Input_Digit(digit)  {
    ...
    if  (Wait_Second_Operand ===true)   {
        ...
        //this overweites Display_Value if the current value is 0
...
function    Input_Decimal(dot)  {
    ...
    if (!Calculator.Display_Value.includes(dot))    {
        //we are saying thst if the Display_Value does not contain a decimal point
...
function    Handle_Operator(Next_Operator)  {
    ...
    //then updates the operator and exits from the funtion
